            ...
            <div class="col-lg-3 col-md-6">
                <div class="single-footer-widget ps-5" data-aos="fade-up" data-aos-delay="60" data-aos-duration="600" data-aos-once="true">
                    ...
                    <ul class="quick-links">
                        <li><a href="about-style-3.php">About Us</a></li>
                        <li><a href="services-style-2.php">Services</a></li>
                        <li><a href="projects.php">Projects</a></li>
                        <li><a href="blog-style-1.php">Blog</a></li>
    ...
    <div class="copyright-area">
        <div class="container">
            <div class="copyright-area-content">
                <p>
                    Copyright @2022 Digi World Solution 
                </p>
            </div>
        </div>
    </div>
